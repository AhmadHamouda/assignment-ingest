package com.iceye.assignments.logging;
...
public class LoggingInterceptor {
    ...
    @Before("execution(* com.iceye.assignments..*.*())")
    ...
    @AfterReturning("execution(* com.iceye.assignments..*.*())")
    ...
    @AfterThrowing(pointcut = "execution(* com.iceye.assignments..*.*())", throwing = "ex")
